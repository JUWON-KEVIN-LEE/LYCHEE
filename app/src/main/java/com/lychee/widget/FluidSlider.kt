...
import com.lychee.R
import com.lychee.widget.FluidSlider.Size.NORMAL
import com.lychee.widget.FluidSlider.Size.SMALL
import kotlin.math.*
...
class FluidSlider @JvmOverloads constructor(
    ...
    private companion object {
        ...
        const val TEXT_START = "좋음"
        const val TEXT_END = "나쁨"
    ...
    init {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                /*if (a.getInteger(R.styleable.FluidSlider_size, 1) == 1) Size.NORMAL.value else Size.SMALL.value */
                val defaultBarHeight = Size.SMALL.value
